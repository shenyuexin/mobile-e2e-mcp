...
This project is indexed by GitNexus as **mobile-e2e-mcp** (6114 symbols, 13973 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
