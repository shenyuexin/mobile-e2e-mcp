...
4. `dry-run-smoke` also validates committed vivo governed-control evidence contracts through `pnpm run validate:governed-control-evidence` and `pnpm run validate:governed-business-app-evidence`
...
- Real-device confidence should be validated through Explorer/probe artifacts first, then historical showcase assets when reviewing demos:
  ...
  - `docs/showcase/evidence/governed-business-app-vivo-2026-05-24/` plus `pnpm run validate:governed-business-app-evidence` for governed business-app vivo evidence
