...
This project is indexed by GitNexus as **mobile-e2e-mcp** (5273 symbols, 12154 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
